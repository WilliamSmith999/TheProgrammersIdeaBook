...
Tips: This is a relatively simple program. 
be sure to first find out how much area the floor is and then multiply that by the cost per unit of flooring. 
start with some simple numbers that you can quickly calculate in your head. try a 10 x 10 ft room with each unit of flooring costing $1.00
